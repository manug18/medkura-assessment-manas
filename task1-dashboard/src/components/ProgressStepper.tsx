...
export default function ProgressStepper({ currentStage, isDark }: Props) {
  return (
    <div className="w-full overflow-x-auto pb-2">
      <div className="min-w-[520px] flex items-start justify-between relative pt-2">
        ...
        <div
          className={`absolute top-6 left-10 right-10 h-1 rounded ${
                ...
                ${
                  isCompleted
                    ...
                    ? `bg-blue-600 text-white ring-4 ${
                        isDark ? 'ring-blue-900' : 'ring-blue-100'
                      }`
